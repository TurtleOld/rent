...
Современное Django приложение для ручного ввода и хранения данных из документов ЕПД (Единый платежный документ) с использованием современных технологий.

## 🚀 Возможности

- **Загрузка PDF** документов ЕПД
- **Ручной ввод данных**: ФИО, адрес, лицевой счет, период оплаты, суммы
...
3. Введите данные вручную в форму
